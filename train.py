            ...
            with torch.no_grad():
                ...
                if iteration < opt.update_until and iteration > opt.start_stat:
                    ...
                    if iteration > opt.update_from and iteration % opt.update_interval == 0:
                        num_inc, num_dec = gaussians.adjust_anchor(ts, check_interval=opt.update_interval, success_threshold=opt.success_threshold, grad_threshold=opt.densify_grad_threshold, min_opacity=opt.min_opacity)
...
if __name__ == "__main__":
    ...
    exp_name = args.model_path.split('/')[-2] + '-timebin'
